...
local function u59(p14, p15, p16, p17, p18, p19, p20, p21)
	-- upvalues: u58 (ref)
	if p14 == nil and (p15 == nil and p16 == nil and p17 == nil and p18 == nil) then
		if p19 == nil then
		end
	end
...
function str_guid(p27)
	-- upvalues: u55 (ref), u58 (ref), u61 (ref)
	u55 = u55 + 50
...
function guid_str(p28)
	-- upvalues: u55 (ref), u60 (ref), u57 (ref)
	u55 = u55 + 32
...
local u62 = (function(p29)
	...
	function _Utilities.ClosestToMouseRadius(p49, p50, p51)
		-- upvalues: _Utilities (ref), u92 (ref)
		local v289 = nil
	...
	function _Utilities.UpdateText(p57)
		-- upvalues: _Text (ref), _Settings (ref), _Utilities (ref), u92 (ref)
	...
	function _Utilities.UpdateTracer(p58)
		-- upvalues: _Tracer (ref), _Settings (ref), _Utilities (ref), CurrentCamera (ref), u92 (ref)
	...
	v106:AddButton({
		...
		Func = function()
			-- upvalues: _Utilities (ref), u97 (ref), n5 (ref), n6 (ref)
	...
	v106:AddToggle("NoclipBetter", {
		...
		NoUI = false,
		Callback = function(_)
			-- upvalues: _Utilities (ref), u92 (ref), u123 (ref), vector3 (ref)
			...
			if u123 then
				...
				(function(p93)
					-- upvalues: u388 (ref), Humanoid (ref)
					local u698 = u388
					local n9 = 0
					...
					game:GetService("RunService"):BindToRenderStep("bypass", Enum.RenderPriority.First.Value, function()
						-- upvalues: Humanoid (ref), u698 (ref), p93 (ref)
	...
	v106:AddButton({
		...
		Func = function()
			-- upvalues: _Utilities (ref), u92 (ref), _tools (ref), _workspace (ref), CurrentCamera (ref)
			...
			if _tools.Teleport.Type == "Vector" then
				...
				local v398 = (function(p97, p98, p99)
					-- upvalues: u393 (ref), _workspace (ref)
					local v704 = p98 - p97
	...
	v106:AddButton({
		...
		Func = function()
			-- upvalues: _Utilities (ref), u92 (ref), _tools (ref), _workspace (ref)
			...
			repeat
				...
				local v411 = (function(p102, p103, p104)
					-- upvalues: u405 (ref), _workspace (ref)
	...
	v106:AddButton({
		...
		Func = function()
			-- upvalues: _Utilities (ref), u92 (ref), _tools (ref), _workspace (ref), u126 (ref)
			...
			repeat
				if g419 or _tools.Teleport.Type ~= "Vector" then
					if not g419 then
						...
						(function(p105)
							-- upvalues: u417 (ref), _tools (ref), u418 (ref)
							local v740 = u417
				...
				local v422 = (function(p106, p107, p108)
					-- upvalues: u416 (ref), _workspace (ref)
	...
	local function u132(p135, p136)
		-- upvalues: u127 (ref), u131 (ref), u128 (ref), u130 (ref), u129 (ref)
	...
	v108:AddButton({
		Text = "Spawn item",
		Func = function()
			-- upvalues: u132 (ref), s11 (ref), n23 (ref)
			u132(s11, n23)
		end,
		DoubleClick = false,
	...
	local function u139(p139)
		-- upvalues: _Utilities (ref), u92 (ref), _workspace (ref), n26 (ref)
	...
	local function u140(p140, p141)
		-- upvalues: _Utilities (ref), u92 (ref), u139 (ref), n25 (ref), n24 (ref)
	...
	if u141 then
		...
		u141.HealthChanged:Connect(function(p199)
			-- upvalues: u143 (ref), timestamp2 (ref), _Utilities (ref), n27 (ref), _tools (ref), u141 (ref)
	...
	_Utilities.GetLocalPlayer().CharacterAdded:Connect(function(character)
		-- upvalues: n27 (ref), u143 (ref), timestamp2 (ref), _Utilities (ref), _tools (ref)
		...
		if character:FindFirstChild("Humanoid") then
			...
			Humanoid.HealthChanged:Connect(function(p200)
				-- upvalues: u143 (ref), timestamp2 (ref), _Utilities (ref), n27 (ref), _tools (ref), Humanoid (ref)
				if not u143 and tick() - timestamp2 > 1.3 then
					_Utilities.log("RESOLVING", "Resolved frozen variable!", "CLIENT")
					timestamp2 = tick()
					u143 = true
	...
	_Utilities.Connections.CamDescendantAdded = CurrentCamera.DescendantAdded:Connect(function(descendant)
		-- upvalues: u147 (ref), _Settings (ref), u148 (ref)
	...
	_Services.UserInputService.InputBegan:Connect(function(input, p201)
		-- upvalues: _tools (ref), CurrentCamera (ref), u146 (ref), cFrame (ref), u151 (ref), u152 (ref)
		if not p201 then
	...
	_Utilities.Connections.LegitBot = _Services.RunService.RenderStepped:Connect(function()
		-- upvalues: u92 (ref), drawing (ref), _Settings (ref), drawing2 (ref), _Utilities (ref), _Hitbox (ref), _workspace (ref), t7 (ref), clone2 (ref), CurrentCamera (ref), u123 (ref), clone3 (ref), n8 (ref), vector3 (ref)
		local v592 = u92
	...
	_Utilities.Connections.Visuals = _Services.RunService.RenderStepped:Connect(function(dt)
		-- upvalues: _Utilities (ref), u92 (ref), _Settings (ref), _Chams (ref), CurrentCamera (ref), t25 (ref), _Services (ref), _tools (ref), u146 (ref), u151 (ref), n28 (ref), u152 (ref), n29 (ref), cFrame (ref)
	...
	_Utilities.Connections.Movement = _Services.RunService.Heartbeat:Connect(function()
		-- upvalues: _Utilities (ref), u92 (ref), _Settings (ref), UserInputService (ref), timestamp3 (ref), CurrentCamera (ref)
	...
	_Utilities.Connections.Remotes = _Services.RunService.RenderStepped:Connect(function()
		-- upvalues: n31 (ref), u92 (ref), t6 (ref), _Utilities (ref), _workspace (ref), _tools (ref), timestamp4 (ref)
	...
	u166 = hookmetamethod(game, "__namecall", function(p202, ...)
		-- upvalues: _Utilities (ref), str (ref), _tools (ref), n31 (ref), u97 (ref), u166 (ref), cFrame (ref), _Settings (ref), CurrentCamera (ref), _workspace (ref), _Services (ref)
					...
					if _Settings.Visuals.Client.Bullet.Enabled and not u97.Unloaded then
						...
						if vector3_6 and typeof(vector3_6) == "Vector3" then
							if _Settings.Visuals.Client.Bullet.Type == "3d" then
								task.spawn(function()
									-- upvalues: _Utilities (ref), CurrentCamera (ref), vector3_6 (ref), _Settings (ref)
								...
								task.spawn(function()
									-- upvalues: _Utilities (ref), _Settings (ref), vector3_6 (ref), _Services (ref), CurrentCamera (ref)
									...
									if Head then
										...
										connection = _Services.RunService.RenderStepped:Connect(function()
											-- upvalues: timestamp5 (ref), BulletLifetime (ref), drawing4 (ref), connection (ref), CurrentCamera (ref), HeadPosition (ref), u758 (ref)
	...
	local connection = game:GetService("RunService").RenderStepped:Connect(function()
		-- upvalues: n32 (ref), timestamp6 (ref), n33 (ref), u97 (ref), s5 (ref)
		n32 = n32 + 1
	...
	u97:OnUnload(function()
		-- upvalues: connection (ref), _Utilities (ref), _Tracer (ref), _Text (ref), drawing (ref), drawing2 (ref), u97 (ref)
		connection:Disconnect()
